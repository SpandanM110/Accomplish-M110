...
export function SkillsPanel({ refreshTrigger }: SkillsPanelProps) {
  ...
  const handleToggle = useCallback(
    async (id: string) => {
      ...
      try {
        ...
        showError(err instanceof Error ? err.message : 'Failed to toggle skill');
      }
    },
    [skills, showError],
  );
  ...
  const handleEdit = useCallback(
    async (filePath: string) => {
      ...
      try {
        ...
        showError(err instanceof Error ? err.message : 'Failed to open skill in editor');
      }
    },
    [showError],
  );
  ...
  const handleShowInFolder = useCallback(
    async (filePath: string) => {
      ...
      try {
        ...
        showError(err instanceof Error ? err.message : 'Failed to show skill in folder');
      }
    },
    [showError],
  );
  ...
  const handleResync = useCallback(async () => {
    ...
    try {
      ...
      showError(err instanceof Error ? err.message : 'Failed to resync skills');
    } finally {
      setIsResyncing(false);
    }
  }, [isResyncing, showError]);
